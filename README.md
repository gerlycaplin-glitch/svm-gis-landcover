...
- The main source of misclassification was **overlap between Lahan Terbuka (Open Land) and Sawah (Paddy Field)**, since both classes can produce similar backscatter intensity when vegetation cover is sparse or fields are newly tilled.
...
2. Install dependencies: `pip install earthengine-api pandas numpy scikit-learn matplotlib seaborn`
3. Authenticate Google Earth Engine: `ee.Authenticate()`
4. Open `main_pipeline.ipynb` and run all cells sequentially
